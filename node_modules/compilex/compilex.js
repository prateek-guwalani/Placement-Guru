...
exports.compileCPPWithInput = function ( envData , code , input , output ,  fn ) { 
	if(exports.stats)
		cppModule.stats = true;
	cppModule.compileCPPWithInput(envData , code , input , output , fn );	
}
...
exports.compileJavaWithInput = function ( envData , code , input, output ,  fn ){
	if(exports.stats)
		javaModule.stats = true;
	javaModule.compileJavaWithInput( envData , code , input, output ,  fn );	
}
...
exports.compilePythonWithInput = function( envData , code , input, output ,  fn){
	if(exports.stats)
		pyModule.stats = true;
	pyModule.compilePythonWithInput(envData , code , input, output , fn );
